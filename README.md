...
This project involved working with unbalanced dataset and exploratory data analysis on how features affected dependent variable. It was a classification problem which involved understanding different scoring metrics and how the data might affect it. Successful deployment ensured a succesful user experience and ensuring python version and model files were consistent. 